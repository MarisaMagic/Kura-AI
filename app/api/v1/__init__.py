...
from .user_agents import agent_chat_router, auth_router as user_agent_auth_router, user_agents_router
...
v1_router.include_router(user_agent_auth_router, prefix="/user-agent", dependencies=[DependAuth])
...
v1_router.include_router(experiment_router, prefix="/experiment", dependencies=[DependAuth])
